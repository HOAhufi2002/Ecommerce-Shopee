      ...
      <div class="grid">
        ...
        <div class="header-with-search">
          ...
          <div class="header__cart">
            <a href="giohang.php" class="header__cart-link"> 
        ...
        <div class="lb7I8Q">
          <div class="p4E7Ry">
            <a href="#">Săn Sale iPhone</a>
            <a href="#">Áo Khoác Nam Đẹp 2024</a>
            <a href="#">Quần Jean</a>
            <a href="#">Áo Thun</a>
            <a href="#">Áo Khoác</a>
            <a href="#">Áo Dài Việt Nam</a>
            <a href="#">Săn Sale iPhone</a>
            <a href="#">Áo Khoác Nam Đẹp 2024</a>
          </div>
        </div>
        ...
        <div class="grid__row app__content">
              ...
              <ul class="category-list">
                ...
                if ($n != 0) {
                  while ($row = mysqli_fetch_array($kq)) {
                    echo "<li class='category-item'><a href='hangtheoloai1.php?maloai=" . $row[0] . "' class='category-item__link'>" . $row[1] . "</a>
                        </li>";
                  }
                }
                ?>
          ...
          <div class="grid__colum-10">
            <div class="home-filter">
              ...
              // Cập nhật truy vấn để lấy sản phẩm với LIMIT và OFFSET
            ...
            <div class="home-product">
              <div class="grid__row">
                ...
                // Truy vấn để lấy sản phẩm với LIMIT và OFFSET, lấy hình ảnh đầu tiên
