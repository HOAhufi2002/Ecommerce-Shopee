    ...
    <div class="app">
                        ...
                        <ul class="header__navbar-list">
                            <li class="header__navbar-item header__navbar-item--has-qr header__navbar-item--separate">
                                ...
                                <div class="header__qr">
                                    <img src="../img/qr2.jpg" alt="QR CODE" class="header__qr-img">
                                    <div class="header__qr-apps">
                                        <a href="" class="header__qr-link">
                                            <img src="../img/google play.png" alt="" class="header__qr-download-img">
                                        </a>
                                        <a href="" class="header__qr-link">
                                            <img src="../img/appstore.png" alt="" class="header__qr-download-img">
                                        </a>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li class="header__navbar-item">
                                ...
                                <a href="" class="haeder__navbar-icon-link">
                        ...
                        <ul class="header__navbar-list">
                            ...
                            <?php if (isset($_SESSION['user'])): ?>
                                <li class="header__navbar-item header__navbar-user">
                                    <img src="../img/tải xuống.png" alt="" class="header__navbar-user-img">
                                    <span class="header__navbar-user-name">
                                        <?php echo $_SESSION['user']['tenkhach']; // Hiển thị tên người dùng 
                                        ?>
                                    </span>
                            ...
                            <?php else: ?>
                                ...
                                <li class="header__navbar-item header__navbar-item--strong">
                                    <a href="login.php" class="header__navbar-item-link">Đăng Nhập</a>
                                </li>
                            <?php endif; ?>
                            </li>
                        </ul>
                        ...
                        <?php foreach ($_SESSION['cart'] as $item): ?>
                            <div class="cart-item">
                                <div class="item-details">
                                    ...
                                    <div class="item-info">
                                        <img src="../img/<?php echo $item['hinh']; ?>" class="item-image" alt="Sản Phẩm">
                                        <div class="item-text">
                                            <p class="item-name" onclick="goToProductDetail()"><?php echo $item['tenhang']; ?></p>
                                            <p class="item-type">Phân Loại Hàng: <?php echo $item['loai']; ?></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="item-price">
                                    <span class="original-price">₫<?php echo number_format($item['gia_goc'], 0, '.', '.'); ?></span>
                                    <span class="sale-price">₫<?php echo number_format($item['gia_giam'], 0, '.', '.'); ?></span>
                                </div>
                                <div class="item-quantity">
                                    <form method="POST">
                                        ...
                                        <input type="number" name="quantity" class="quantity-input" value="<?php echo $item['so_luong']; ?>" min="1" onchange="this.form.submit()">
                                        <button type="submit" name="update" class="quantity-btn plus-btn">+</button>
                                    </form>
                                </div>
                                <div class="item-total">₫<?php echo number_format($item['gia_giam'] * $item['so_luong'], 0, '.', '.'); ?></div>
        ...
        <footer class="footer">
                ...
                <div class="grid__row">
                    <div class="grid__colum-2-4">
                        ...
                        <ul class="footer-list">
                            ...
                            <li class="footer-item">
                                <a href="" class="footer-item__link">Fb:Hà Đạt</a>
                            </li>
                            <li class="footer-item">
                    ...
                    <div class="grid__colum-2-4">
                        ...
                        <ul class="footer-list">
                            ...
                            <li class="footer-item">
                                <a href="" class="footer-item__link">Áo Quần Trẻ Em</a>
                            </li>
                        </ul>
                    ...
                    <div class="grid__colum-2-4">
                        <h3 class="footer__heading">Ngân hàng Admin</h3>
                        <div class="footer__bank">
                            <img src="../img/qr1.png" alt="" class="footer__bank-qr">
                            <div class="footer__bank-app">
                                <a href="" class="footer__bank-app-img-link">
                                    <img src="../img/google play.png" alt="App Store" class="footer__bank-app-img-ggplay">
                                </a>
                                <a href="" class="footer__bank-app-img-link">
                                    <img src="../img/appstore.png" alt="Google Play" class="footer__bank-app-img-appstore">
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="footer__bottom">
                <div class="grid">
                    <p class="footer__text">Copyright by Hà Đình Đạt - Bản Quyền Thuộc Về Hà Đình Đạt</p>
                </div>
            </div>
        </footer>
