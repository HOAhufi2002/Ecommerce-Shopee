                                ...
                                <div class="buttons">
                                    <?php if ($so_luong > 0) { ?>
                                        <form action="" method="POST">
                                            ...
                                            <input type="hidden" name="so_luong" value="1"> <!-- Thay đổi giá trị này -->
                                            <button type="submit" class="add-to-cart"><i class="fa-solid fa-cart-shopping"></i> Thêm Vào Giỏ Hàng</button>
                                        </form>
